...
/**
 示例入参: MZDemo://MZFirst?id=102&username=hi
 示例出参:
 MZFirst -> MZFirstViewController
 params:{ @"id": @"102",
          @"username": @"hi"
        }
 */
...
- (NSDictionary *)routeKeyClass
{
    if (!_routeKeyClass)
    {
        NSString *path = [[NSBundle mainBundle] pathForResource:@"MZRoute" ofType:@"plist"];
